...
vowel_color_dict = {'AA': [(0, 255, 0), (4, 0, 0)],
                    'AE': [(255, 214, 0), (0, 1, 0)],
                    'AH': [(0, 174, 0), (4, 2, 0)],
                    'AO': [(0, 171, 255), (4, 2, 2)],
...
consonant_color_dict = {'B': [(254, 255, 0), (1, 1, 0)],
                        # if in group 1, get 1 pt, elif P, get 2pts, elif B, get 3pts, else get 0 pts
                        'P': [(254, 255, 0), (1, 1, 1)],
                        'D': [(254, 255, 0), (1, 2, 0)],
                        'T': [(254, 255, 0), (1, 2, 1)],
                        'G': [(254, 255, 0), (1, 3, 0)],
...
T1 = 2.5  # Rhyme stressed vowel threshold, maximum vowel distance required to count as a rhyme
T2 = 1  # Rhyme stressed vowel consonance threshold, minimum consonance score to count as a rhyme
